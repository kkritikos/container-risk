...
public class GrypeRunner implements ToolRunner {
	...
	public static List<String> getResultFilesFromImageNames(List<String> images){
		List<String> fileNames = new ArrayList<String>(images.size());
		for (String image: images) {
			fileNames.add(imagesDir + File.separator + image.replace(':', '_') + filePostfix);
		}
